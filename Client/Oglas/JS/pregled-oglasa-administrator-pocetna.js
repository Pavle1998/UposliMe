...
//div za desne labele
    ...
    document.querySelectorAll(".odabranDiv").forEach(e=>{
...
izmeniBtn.addEventListener("click",function(){
    location.href="../korisnikAdministrator/administrator-izmeni-oglas.html?username="+username+"&oglas="+oglasId;
})

//funkcija za dugme obrisi
obrisiBtn.addEventListener("click",function(){
    fetch(`http://localhost:5258/Oglas/ObrisiOglasAdministrator/${prosledjenOglas.id}/`,  
    {
        method: "DELETE"
    }).then(p=>
        {
...
zadrugaBtn.addEventListener("click",function(){  
    location.href="../../Administrator/korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&zadruga="+zadrugaBtn.id;
})

let poslodavacBtn=document.querySelector(".poslodavac");
poslodavacBtn.addEventListener("click",function(){  
    location.href="../../Administrator/korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&poslodavac="+poslodavacBtn.id;
})
...
zadrugarBtns.forEach(zadrugarBtn=>{
    zadrugarBtn.addEventListener("click",function(){  
        location.href="../../Administrator/korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&zadrugar="+zadrugarBtn.id;
    })
})