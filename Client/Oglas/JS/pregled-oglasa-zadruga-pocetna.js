...
izmeniBtn.addEventListener("click",function(){
    location.href="../../Zadruga/korisnikZadruga/zadruga-izmeni-oglas.html?username="+username+"&oglas="+oglasId;
})

//funkcija za dugme obrisi
obrisiBtn.addEventListener("click",function(){
    fetch(`http://localhost:5258/Oglas/ObrisiOglasZadruga/${prosledjenOglas.id}/${zadruga.id}`,          
            {
                method: "DELETE"
            }).then(p=>
                {
