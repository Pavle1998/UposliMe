...
//div za desne labele
    ...
    let otkaziValidacijuBtn = document.createElement("button");
    otkaziValidacijuBtn.className="Dugme otkaziValidacijuBtn";
    otkaziValidacijuBtn.innerHTML="Otkaži validaciju";
    divDugme.appendChild(otkaziValidacijuBtn);
...
otkaziValidacijuBtn.addEventListener("click",function(){
