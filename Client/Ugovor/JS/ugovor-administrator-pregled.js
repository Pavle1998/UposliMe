...
zadrugaBtn.addEventListener("click",function(){  
    location.href="../korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&zadruga="+zadrugaBtn.id+"&oglas="+ugovor.oglas.id;
})

let poslodavacBtn=document.querySelector(".poslodavac");
poslodavacBtn.addEventListener("click",function(){  
    location.href="../korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&poslodavac="+poslodavacBtn.id+"&oglas="+ugovor.oglas.id;
})

let zadrugarBtn=document.querySelector(".zadrugar");
zadrugarBtn.addEventListener("click",function(){  
        location.href="../korisnikAdministrator/administrator-prikaz-korisnika.html?username="+username+"&zadrugar="+zadrugarBtn.id+"&oglas="+ugovor.oglas.id;
})